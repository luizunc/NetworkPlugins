...
import dev.slickcollections.kiwizin.mysterybox.hook.container.CosmeticsContainer;
...
public abstract class Cosmetic {
  ...
  public void give(Profile profile) {
    profile.getAbstractContainer("kMysteryBox", "cosmetics", CosmeticsContainer.class).addCosmetic(this);
  }
  
  public boolean has(Profile profile) {
    return profile.getAbstractContainer("kMysteryBox", "cosmetics", CosmeticsContainer.class).hasCosmetic(this);
  }
  
  public boolean isSelected(Profile profile) {
    return profile.getAbstractContainer("kMysteryBox", "selected", SelectedContainer.class).isSelected(this);
  }
