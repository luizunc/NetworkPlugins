package dev.slickcollections.kiwizin.bedwars.menus.cosmetics;
...
import dev.slickcollections.kiwizin.bedwars.cosmetics.object.AbstractPreview;
...
import dev.slickcollections.kiwizin.bedwars.cosmetics.types.DeathCry;
import dev.slickcollections.kiwizin.bedwars.cosmetics.types.DeathMessage;
          ...
          if (item != null && item.getType() != Material.AIR) {
            if (evt.getSlot() == this.previousPage) {
              ...
              if (cosmetic != null) {
                ...
                if (!cosmetic.has(profile)) {
                  if (!cosmetic.canBuy(this.player) || (profile.getCoins("kCoreBedWars") < cosmetic.getCoins() && (CashManager.CASH && profile
                ...
                if (cosmetic.isSelected(profile)) {
                  profile.getAbstractContainer("kCoreBedWars", "selected", SelectedContainer.class).setSelected(cosmetic.getType(), 0);
                } else {
                  profile.getAbstractContainer("kCoreBedWars", "selected", SelectedContainer.class).setSelected(cosmetic);
                }
