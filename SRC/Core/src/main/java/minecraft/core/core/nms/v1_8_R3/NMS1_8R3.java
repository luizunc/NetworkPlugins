...
public class NMS1_8R3 implements INMS {
  ...
  public NMS1_8R3() {
    ...
    CLASS_TO_NAME.get(null).put(minecraft.core.core.nms.v1_8_R3.entity.EntityArmorStand.class, "kCore-ArmorStand");
    CLASS_TO_ID.get(null).put(minecraft.core.core.nms.v1_8_R3.entity.EntitySlime.class, 55);
    CLASS_TO_NAME.get(null).put(minecraft.core.core.nms.v1_8_R3.entity.EntitySlime.class, "kCore-Slime");
    CLASS_TO_ID.get(null).put(minecraft.core.core.nms.v1_8_R3.entity.EntityItem.class, 1);
    CLASS_TO_NAME.get(null).put(minecraft.core.core.nms.v1_8_R3.entity.EntityItem.class, "kCore-Item");
