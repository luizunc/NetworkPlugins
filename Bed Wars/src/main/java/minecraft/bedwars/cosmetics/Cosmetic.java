package minecraft.bedwars.cosmetics;

import minecraft.bedwars.Main;
import minecraft.bedwars.cosmetics.types.*;
import minecraft.bedwars.hook.container.CosmeticsContainer;
...
public abstract class Cosmetic {
  ...
  public void give(Profile profile) {
    profile.getAbstractContainer("bedwars", "cosmetics", CosmeticsContainer.class).addCosmetic(this);
  }
  
  public boolean has(Profile profile) {
    return profile.getAbstractContainer("bedwars", "cosmetics", CosmeticsContainer.class).hasCosmetic(this);
  }
  
  public boolean isSelected(Profile profile) {
    return profile.getAbstractContainer("bedwars", "selected", SelectedContainer.class).isSelected(this);
  }
