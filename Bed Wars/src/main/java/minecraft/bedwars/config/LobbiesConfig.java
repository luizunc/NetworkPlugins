...
public final class LobbiesConfig {
    ...
    private static final String ADDRESS_LOBBY_1 = "127.0.0.1:25567";
    private static final String ADDRESS_LOBBY_2 = "127.0.0.1:0";
    private static final String ADDRESS_LOBBY_3 = "127.0.0.1:0";
    private static final String ADDRESS_LOBBY_4 = "127.0.0.1:0";
    private static final String ADDRESS_LOBBY_5 = "127.0.0.1:0";

    // Capacidade máxima de jogadores
    private static final int MAX_PLAYERS = 50;

    // Template do ícone base (vidro branco com nome em branco)
    private static final String ICON_TEMPLATE = "STAINED_GLASS:0 : 1 : nome>&fLobby %d : desc>&fJogadores: &7{players}/{maxplayers}\n \n{description}";
    
    // Template do ícone para lobby atual (vidro verde lima)
    private static final String CURRENT_LOBBY_ICON_TEMPLATE = "STAINED_GLASS:5 : 1 : nome>&aLobby %d : desc>&fJogadores: &7{players}/{maxplayers}\n \n{description}";
    ...
    /**
     * Obtém todos os nomes dos servidores disponíveis.
     * @return conjunto de nomes de servidores
     */
    public static java.util.Set<String> getServerNames() {
        return LOBBY_ITEMS.keySet();
    }
    
    /**
     * Obtém o ícone para um lobby específico.
     * @param lobbyNumber número do lobby
     * @param isCurrent se é o lobby atual
     * @return string do ícone
     */
    public static String getLobbyIcon(int lobbyNumber, boolean isCurrent) {
        if (isCurrent) {
            return String.format(CURRENT_LOBBY_ICON_TEMPLATE, lobbyNumber);
        } else {
            return String.format(ICON_TEMPLATE, lobbyNumber);
        }
    }
    ...
    public static final class LobbyItem {
        ...
        /**
         * Obtém apenas o endereço do servidor (sem nome).
