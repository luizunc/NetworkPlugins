...
public class KConfig {
  ...
  /**
   * Construtor para criar KConfig a partir de uma FileConfiguration existente
   * @param config FileConfiguration já carregada
   */
  public KConfig(org.bukkit.configuration.file.FileConfiguration config) {
    this.plugin = null;
    this.file = null;
  ...
  /**
   * Obtém a configuração como Configuration do BungeeCord
   * @return Configuration para compatibilidade com BungeeCord
   */
  public net.md_5.bungee.config.Configuration getConfiguration() {
    try {
      return net.md_5.bungee.config.YamlConfiguration.getProvider(net.md_5.bungee.config.YamlConfiguration.class)
          .load(new java.io.FileInputStream(this.file));
    } catch (Exception e) {
      return null;
    }
  }
