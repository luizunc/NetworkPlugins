...
public class NPCAdapter extends PacketAdapter {
  ...
  public NPCAdapter(minecraft.core.bukkit.Core plugin) {
    super(params().plugin(plugin).types(PacketType.Play.Server.ENTITY_STATUS, PacketType.Play.Server.NAMED_ENTITY_SPAWN, PacketType.Play.Server.PLAYER_INFO));
  }
