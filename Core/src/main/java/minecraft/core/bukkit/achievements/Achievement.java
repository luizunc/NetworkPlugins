package minecraft.core.bukkit.achievements;
...
public abstract class Achievement {
  ...
  public static void setupAchievements() {
    ...
    // TheBridgeAchievement.setupAchievements(); // Removido - The Bridge não é mais suportado
    // MurderAchievement.setupAchievements(); // Removido - Murder não é mais suportado
  }
