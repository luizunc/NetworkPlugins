package minecraft.core.core.nms.v1_8_R3;
...
import minecraft.core.core.libraries.npclib.api.npc.NPCAnimation;
import minecraft.core.core.libraries.npclib.npc.EntityControllers;
import minecraft.core.core.libraries.npclib.npc.ai.NPCHolder;
import minecraft.core.core.libraries.npclib.npc.skin.SkinnableEntity;
import minecraft.core.core.nms.interfaces.INMS;
import minecraft.core.core.nms.interfaces.entity.IArmorStand;
import minecraft.core.core.nms.interfaces.entity.IItem;
import minecraft.core.core.nms.interfaces.entity.ISlime;
import minecraft.core.core.nms.v1_8_R3.entity.*;
import minecraft.core.core.nms.v1_8_R3.utils.PlayerlistTrackerEntry;
import minecraft.core.core.nms.v1_8_R3.utils.UUIDMetadataStore;
...
public class NMS1_8R3 implements INMS {
  ...
  public NMS1_8R3() {
    ...
    CLASS_TO_ID.get(null).put(EntityStand.class, 30);
          CLASS_TO_NAME.get(null).put(EntityStand.class, "Core-EntityStand");
    CLASS_TO_ID.get(null).put(minecraft.core.core.nms.v1_8_R3.entity.EntityArmorStand.class, 30);
          CLASS_TO_NAME.get(null).put(minecraft.core.core.nms.v1_8_R3.entity.EntityArmorStand.class, "Core-ArmorStand");
    CLASS_TO_ID.get(null).put(minecraft.core.core.nms.v1_8_R3.entity.EntitySlime.class, 55);
          CLASS_TO_NAME.get(null).put(minecraft.core.core.nms.v1_8_R3.entity.EntitySlime.class, "Core-Slime");
    CLASS_TO_ID.get(null).put(minecraft.core.core.nms.v1_8_R3.entity.EntityItem.class, 1);
          CLASS_TO_NAME.get(null).put(minecraft.core.core.nms.v1_8_R3.entity.EntityItem.class, "Core-Item");
  ...
  public IArmorStand createArmorStand(Location location, String name, HologramLine line) {
    IArmorStand armor = line == null ? new EntityStand(location) : new minecraft.core.core.nms.v1_8_R3.entity.EntityArmorStand(((CraftWorld) location.getWorld()).getHandle(), line);
  ...
  public IItem createItem(Location location, ItemStack item, HologramLine line) {
    minecraft.core.core.nms.v1_8_R3.entity.EntityItem eitem = new minecraft.core.core.nms.v1_8_R3.entity.EntityItem(((CraftWorld) location.getWorld()).getHandle(), line);
  ...
  public ISlime createSlime(Location location, HologramLine line) {
    minecraft.core.core.nms.v1_8_R3.entity.EntitySlime slime = new minecraft.core.core.nms.v1_8_R3.entity.EntitySlime(((CraftWorld) location.getWorld()).getHandle(), line);
  ...
  public Hologram getHologram(Entity entity) {
    ...
    HologramLine e = null;
    if (en instanceof minecraft.core.core.nms.v1_8_R3.entity.EntityArmorStand) {
      e = ((minecraft.core.core.nms.v1_8_R3.entity.EntityArmorStand) en).getLine();
    } else if (en instanceof minecraft.core.core.nms.v1_8_R3.entity.EntitySlime) {
      e = ((minecraft.core.core.nms.v1_8_R3.entity.EntitySlime) en).getLine();
    } else if (en instanceof minecraft.core.core.nms.v1_8_R3.entity.EntityItem) {
      e = ((minecraft.core.core.nms.v1_8_R3.entity.EntityItem) en).getLine();
    }
